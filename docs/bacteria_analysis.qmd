...
### Testing E. coli log change for normal distribution for each species
...
### Testing Enterococcus log change for normal distribution for each species
...
## Analysis how susbtrate is influencing the Bacteria log-change
